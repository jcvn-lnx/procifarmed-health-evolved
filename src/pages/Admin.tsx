      ...
      <main className="py-10">
        <Container>
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">Pedidos e produtos (CRUD) usando o backend do Lovable Cloud.</p>
          </div>
          ...
          <Tabs defaultValue="orders">
            ...
            <TabsContent value="orders" className="mt-6">
              <div className="flex flex-wrap items-end justify-between gap-4">
                <div>
                  <h2 className="font-display text-2xl font800 tracking-tight">Pedidos</h2>
                  <p className="mt-2 text-sm text-muted-foreground">Listar e atualizar status/pagamento.</p>
                </div>
